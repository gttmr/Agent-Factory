...
3. `af-build-runtime-stub`: approved scaffold-plan -> smoke TODO handoff or reviewed runnable ADK Workflow handoff.
...
- Keep generated source as a reviewed handoff surface. Smoke output stays TODO/runtime wiring; runnable output may execute only reviewed synthetic ADK Workflow wiring and must not contain real business logic.
