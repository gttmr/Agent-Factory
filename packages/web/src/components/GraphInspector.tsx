...
export function GraphInspector(props: GraphInspectorProps) {
  ...
  if (selectedNode) {
    ...
    const hasMockLab = Boolean(selectedNode.mock_binding);
    const hasAdkCompat = Boolean(selectedNode.adk_skeleton_contract || selectedNode.adk_node_role);
