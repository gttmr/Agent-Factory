...
import { buildAnalysisResultArtifact, serializeAnalysisResultArtifact } from "./analysisArtifactExport.ts";
...
const reviewedArtifact = buildAnalysisResultArtifact({
...
const serialized = serializeAnalysisResultArtifact({
  analysis: imported.analysis,
